...
export interface IBootCamp02BbbTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IBootCamp02BbbTabRemoveProps {

}

/**
 * Implementation of BootCamp 02 BBB remove page
 */
export class BootCamp02BbbTabRemove  extends TeamsBaseComponent<IBootCamp02BbbTabRemoveProps, IBootCamp02BbbTabRemoveState> {
